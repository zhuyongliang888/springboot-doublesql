...
@Configuration
@MapperScan(basePackages = DuridOracleDBConfig.PACKAGE, sqlSessionFactoryRef = "masterSqlSessionFactory")
public class DuridOracleDBConfig
{
    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    static final String PACKAGE = "com.hoperun.oracle.demo.dao";
    static final String MAPPER_LOCATION = "classpath:com/hoperun/oracle/demo/dao/*.xml";
    ...
    @Value("${oracle.config.decrypt.key}")
    private String configDecryptKey;
	...
	reg.addInitParameter("loginUsername", "admin_oracle");
	...
	try
	{
	    datasource.setPassword(ConfigTools.decrypt(configDecryptKey,password));
	} catch (Exception e1)
	{
	...
	sessionFactory.setMapperLocations(
		new PathMatchingResourcePatternResolver().getResources(DuridOracleDBConfig.MAPPER_LOCATION));
