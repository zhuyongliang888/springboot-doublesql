...
@Configuration
@MapperScan(basePackages = DuridMysqlDBConfig.PACKAGE, sqlSessionFactoryRef = "clusterSqlSessionFactory")
public class DuridMysqlDBConfig
{
    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    static final String PACKAGE = "com.hoperun.mysql.demo.dao";
    static final String MAPPER_LOCATION = "classpath:com/hoperun/mysql/demo/dao/*.xml";
    ...
    @Value("${mysql.config.decrypt.key}")
	...
	sessionFactory.setMapperLocations(
		new PathMatchingResourcePatternResolver().getResources(DuridMysqlDBConfig.MAPPER_LOCATION));
